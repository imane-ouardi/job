...
<section class="container px-4 mx-auto">
    ...
    <div class="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
        <a  class="group px-3 py-10 rounded-md bg-white transition duration-500">
            <div class="size-16 bg-blue-500/5 group-hover:bg-blue-500 text-blue-800 group-hover:text-white rounded-md text-2xl flex align-middle justify-center items-center shadow-xs shadow-gray-200 transition duration-500 mx-auto">
        ...
        <div class="container md:mt-24 md:pb-16 mt-16">
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                <div class="lg:col-span-5 md:col-span-6">
                    <div class="relative">
                        <div class="relative"><img class="lg:w-[400px] w-[280px] rounded-md shadow-sm shadow-gray-200 "
                                alt="" src="/assets/images/ab01-Dky8rhyA.jpg">


                        </div>

                        <div class="absolute md:-end-5 end-0 -bottom-16">
                            <img class="lg:w-[280px] w-[200px] border-8 border-white  rounded-md shadow-sm shadow-gray-200 "
                                alt="" src="/assets/images/ab02-Dnw9ga1r.jpg">
                        </div>
                ...
                <div class="lg:col-span-7 md:col-span-6 mt-14 md:mt-0">
                    <div class="lg:ms-5">
                        <h3 class="mb-6 md:text-[26px] text-2xl md:leading-normal leading-normal font-semibold">Millions
                            of jobs. <br> Find the one that's right for you.</h3>
                        <p class="text-blue-800 max-w-xl">Search all the open positions on the web. Get your own
                            personalized salary estimate. Read reviews on over 30000+ companies worldwide.
                        </p>
                        <ul class="list-none text-blue-800 mt-4 ">
                            <li class="mb-1 flex items-center">

                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                    class="text-blue-800 text-xl me-2" height="1em" width="1em"
                                ...
                                </svg>Digital Marketing Solutions for Tomorrow
                            </li>
                            <li class="mb-1 flex items-center">
                                ...
                                </svg> Our Talented &amp; Experienced Marketing Agency
                            </li>
                            <li class="mb-1 flex items-center">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                    class="text-blue-800 text-xl me-2" height="1em" width="1em"
                                ...
                                </svg> Create your own skin to match your brand
                            </li>
                        </ul>
                        <div class="mt-6">
                            <a class="py-1 px-5 inline-flex items-center font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-blue-500 hover:bg-blue-800 border-blue-800 hover:border-blue-800 text-white mt-2 rounded-md"
                                href="{{ route('contact') }}" data-discover="true">
                                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
                                    stroke-linecap="round" stroke-linejoin="round" class="me-2" height="1em"
