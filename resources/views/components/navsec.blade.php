        ...
        <div class="relative flex items-center justify-between -mx-4">
            <div class="max-w-full px-4 w-60">
                <a href="{{ route('home') }}" class="block w-full py-5 navbar-logo">
                    <img src="assets/images/logo/logoo.svg" alt="logo" class=" h-12 w-25 header-logo" />
                </a>
            </div>
                ...
                <div class="flex items-center justify-end pr-16 lg:pr-0">
                    ...
                    @if (!auth()->check())
                        <div class="hidden sm:flex">
                            ...
                            <a href="{{ route('signup') }}"
                                class="px-6 py-2 text-base font-medium text-white duration-300 ease-in-out rounded-md bg-white/20 signUpBtn ">
                                Sign Up
                            </a>
                        </div>
                    @else
