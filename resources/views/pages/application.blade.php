...
<x-navsec />
        ...
        <section class="relative w-full min-h-[60vh] flex flex-col justify-center bg-gradient-to-br from-blue-700 via-blue-900 to-blue-700 bg-cover">
          ...
          <!-- ====== Hero Section End ====== -->
<section class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 py-12 px-4">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 w-full max-w-2xl">
        <h2 class="text-2xl font-bold text-center text-gray-800 dark:text-white mb-6">Job Application Form</h2>
        ...
        <form action="{{ route('applications.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Full Name -->
            <div>
                <label for="full_name" class="block mb-2 font-semibold text-gray-700 dark:text-gray-200">Full Name</label>
            ...
            <!-- Email -->
            <div>
                <label for="email" class="block mb-2 font-semibold text-gray-700 dark:text-gray-200">Email</label>
            ...
            <!-- Phone Number -->
            <div>
                <label for="phone" class="block mb-2 font-semibold text-gray-700 dark:text-gray-200">Phone Number</label>
            ...
            <!-- Education -->
            <div>
                <label for="education" class="block mb-2 font-semibold text-gray-700 dark:text-gray-200">Education</label>
            ...
            <!-- Work Experience -->
            <div>
                <label for="experience" class="block mb-2 font-semibold text-gray-700 dark:text-gray-200">Work Experience</label>
            ...
            <!-- Skills -->
            <div>
                <label for="skills" class="block mb-2 font-semibold text-gray-700 dark:text-gray-200">Skills</label>
            ...
            <!-- Resume Upload -->
            <div>
                <label for="cv" class="block mb-2 font-semibold text-gray-700 dark:text-gray-200">Upload Resume (PDF or DOCX)</label>
            ...
            <!-- Extra File (optional) -->
            <div>
                <label for="extra_file" class="block mb-2 font-semibold text-gray-700 dark:text-gray-200">Additional File (Optional)</label>
            ...
            <!-- Cover Letter -->
            <div>
                <label for="cover_letter" class="block mb-2 font-semibold text-gray-700 dark:text-gray-200">Cover Letter</label>
            ...
            <div class="flex items-center">
                ...
                <label for="terms" class="text-sm text-gray-700 dark:text-gray-300">I agree to the <a href="#" class="underline">terms and conditions</a></label>
            </div>
